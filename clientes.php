...
<body>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="titulo_modal">Alta de Cliente</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        id="cerrar"></button>
                </div>
                <div class="modal-body" id="modal-body"></div>
                <div class="modal-footer">
                    <button type="button" class="btn-custom invisible" id="Guardar_Edita">Editar Cliente</button>
                    <button type="button" class="btn-custom" id="Guardar_Nuevo">Agregar Cliente</button>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <table id="clientesTable" class="table table-striped table-sm compact">
                <thead>
                    <tr>
                ...
                <tbody id="resultados_clientes"></tbody>
            </table>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on("click", "#nuevo", function () {
                ...
                $("#Guardar_Nuevo").show();
                $("#Guardar_Edita").hide();
                $("#titulo_modal").text("Alta de Cliente");
            });
            ...
            $(document).on("click", ".editar", function () {
                ...
                $("#titulo_modal").text("Editar Cliente");
                $('#modal').modal('show');
            });
